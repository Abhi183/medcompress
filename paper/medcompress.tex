...
\textbf{ISIC 2020}~\citep{codella2019isic} contains 33,126 dermoscopy images for binary melanoma classification (prevalence ${\sim}$2\%). Images were resized to $224{\times}224$, normalized to $[-1, 1]$, and augmented with random flips, brightness ($\pm 0.2$), and contrast ($\pm 0.2$). Inverse-frequency class weighting addressed the imbalance. We used stratified 70/15/15 train/validation/test splits.

\textbf{BraTS 2021}~\citep{baid2021brats} provides multi-modal MRI volumes (T1, T1ce, T2, FLAIR) with four segmentation classes (background, necrotic core, peritumoral edema, enhancing tumor). Labels were remapped from $\{0,1,2,4\}$ to $\{0,1,2,3\}$. We employed a 2.5D strategy: three adjacent axial slices stacked across four modalities yield a 12-channel $128{\times}128$ input, providing inter-slice context without the computational cost of 3D convolutions. Background-only slices were filtered; each volume was z-score normalized independently.
...
\midrule
EffNetB0 & FP32 & 16.2 & 1.0 & .912\tiny$\pm$.004 & .741\tiny$\pm$.018 & .623\tiny$\pm$.021 \\
EffNetB0 & INT8 & 4.3 & 3.8 & .897\tiny$\pm$.005 & .718\tiny$\pm$.022 & .598\tiny$\pm$.024 \\
EffNetB0 & FP16 & 8.1 & 2.0 & .910\tiny$\pm$.004 & .736\tiny$\pm$.019 & .618\tiny$\pm$.022 \\
\midrule
U-Net & FP32 & 124.1 & 1.0 & .871\tiny$\pm$.008 & .852\tiny$\pm$.012 & .863\tiny$\pm$.010 \\
U-Net & INT8 & 31.4 & 3.9 & .849\tiny$\pm$.010 & .831\tiny$\pm$.015 & .841\tiny$\pm$.013 \\
U-Net & FP16 & 62.1 & 2.0 & .868\tiny$\pm$.009 & .849\tiny$\pm$.013 & .860\tiny$\pm$.011 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
None & --- & 196 & 1.0$\times$ & .912\tiny$\pm$.004 & --- \\
\midrule
1D & 4 & 49 & 4.0$\times$ & .905\tiny$\pm$.005 & $-$0.77\% \\
1D & 8 & 25 & 7.8$\times$ & .893\tiny$\pm$.007 & $-$2.08\% \\
\midrule
2D & 2$\times$2 & 49 & 4.0$\times$ & .909\tiny$\pm$.004 & $-$0.33\% \\
2D & 4$\times$4 & 16 & 12.3$\times$ & .901\tiny$\pm$.006 & $-$1.21\% \\
2D & 7$\times$7 & 4 & 49.0$\times$ & .862\tiny$\pm$.011 & $-$5.48\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{@{}llrrcc@{}}
\toprule
Pipeline & Task & MB & ms & Metric & F1 \\
\midrule
Baseline & ISIC & 16.2 & 48.3 & .912\tiny$\pm$.004 & .623\tiny$\pm$.021 \\
QAT INT8 & ISIC & 4.3 & 14.1 & .897\tiny$\pm$.005 & .598\tiny$\pm$.024 \\
Scratch & ISIC & 10.2 & 22.7 & .871\tiny$\pm$.007 & .561\tiny$\pm$.028 \\
KD & ISIC & 10.2 & 22.7 & .896\tiny$\pm$.005 & .601\tiny$\pm$.023 \\
KD+QAT & ISIC & 2.7 & 8.3 & .883\tiny$\pm$.006 & .582\tiny$\pm$.026 \\
\midrule
Baseline & BraTS & 124.1 & 312.5 & .871\tiny$\pm$.008 & .863\tiny$\pm$.010 \\
QAT INT8 & BraTS & 31.4 & 89.2 & .849\tiny$\pm$.010 & .841\tiny$\pm$.013 \\
Scratch & BraTS & 15.6 & 41.8 & .793\tiny$\pm$.012 & .789\tiny$\pm$.016 \\
KD & BraTS & 15.6 & 41.8 & .821\tiny$\pm$.009 & .814\tiny$\pm$.012 \\
KD+QAT & BraTS & 4.1 & 12.6 & .804\tiny$\pm$.011 & .797\tiny$\pm$.014 \\
\bottomrule
\end{tabular}
\end{table}
